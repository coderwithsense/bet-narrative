...
const CreateStoryButton = ({ className }: { className?: string }) => {
  const {addStory} = useCreatorStories()
  ...
  return (
    <div className={className}>
      <Modal>
        <ModalTrigger className="btn-primary relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 gap-2">
